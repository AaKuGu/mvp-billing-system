...
const BillingCard = ({ data, index }) => {
  ...
  return (
    <div className="w-full flex items-center justify-between p-2 mb-1 bg-white shadow-md shadow-blue-100 rounded-lg hover:shadow-blue-200 transition-shadow duration-200">
      {/* Left Section */}
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-gray-500">Bill Date: {createdDate}</p>
        </div>
      </div>
